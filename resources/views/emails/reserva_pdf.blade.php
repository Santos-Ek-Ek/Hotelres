...
<body>
<div class="container">
        <h1 class="text-lg font-bold text-center mb-4">Hotel Truck</h1>
        ...
        <div class="mb-4">
            ...
            <!-- Usamos una tabla para asegurar compatibilidad con PDF -->
            <table>
                <tr>
                    <!-- Columna izquierda: Check-in y Check-out -->
                    <td class="align-top">
